    ...
    while (!done && ((command = reader.readLine()) != null)) {
      ...
      switch (command.toUpperCase()) {
        ...
        case RouletteV2Protocol.CMD_LOAD:
          ...
          writer.flush();
          int oldStudents = store.getNumberOfStudents();
          store.importData(reader);
          int newStudents = store.getNumberOfStudents() - oldStudents;
          writer.println(JsonObjectMapper.toJson(new LoadCommandResponse("success", newStudents)));
          writer.flush();
          break;
